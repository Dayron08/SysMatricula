    ...
    <div class="row  " id="row-login">
        <div class="col-12 som-2 col-lg-5 bg-light p-lg-5 p-4 pb-3">
            <div class="encabezado mb-4">
                <h1 class="text-1">Cambio de contrase&ntilde;a</h1>
            ...
            <form action="@Url.Content("~/Login/CambiarContrasena")" method="post">
                <label for="usuario"><i class="fa-solid fa-at"></i> Correo Electrónico</label>
                <input type="email" class="form-control" id="email" name="correo" onfocusout="EnviarValidacionEmail('email','msj')" placeholder="nombre@dominio.com" required>

                <label for="contrasena"><i class="fa-solid fa-lock"></i> Nueva Contraseña</label>
                <div class="input-group p-0">
                    <input type="password" class="form-control" placeholder="Contraseña mayor a 4 caracteres" name="pass2" id="pass" minlength="4" required>
                    <span class="input-group-text bg-white "><i class="fa-regular fa-eye-slash" id="passEye2" onclick="EyePass('pass')"></i></span>
                </div>
                <label for="contrasena"><i class="fa-solid fa-lock"></i> Confirmar Contraseña</label>
                <div class="input-group p-0">
                    <input type="text" class="form-control" placeholder="Contraseña mayor a 4 caracteres" name="contrasena" id="pass" minlength="4" required>
                </div>
                <div class="d-grid my-4">
                    <span id="msj" class=" text-small mb-3 d-none"><i class="fa-solid fa-circle-info"></i> El correo ingresado es valido </span>

                    <button type="submit" class="btn btn-outline-light bg-1 ">Cambiar Clave</button>
                    <div class="Registro mt-3 text-center ">
                        ...
                        <span class="text-a text-small d-block"><a href="@Url.Action("Index", "Login")" class="text-3">Ya tengo cuenta</a></span>
